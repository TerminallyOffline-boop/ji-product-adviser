...
enum class CompatibilityStatus { MEETS_RECOMMENDED, MEETS_MINIMUM, BELOW_MINIMUM, NOT_VERIFIED }
enum class ComponentStatus { MEETS_RECOMMENDED, MEETS_MINIMUM, BELOW_MINIMUM, UNKNOWN, NOT_APPLICABLE }
