...
fun RecommendationScreen(onProduct:(Long)->Unit,viewModel:RecommendationViewModel=hiltViewModel()){
    ...
    val resetAll={viewModel.reset();query="";softwareQuery=""}
    LazyColumn(Modifier.fillMaxSize().padding(20.dp),verticalArrangement=Arrangement.spacedBy(12.dp)){
        ...
        item{Row(horizontalArrangement=Arrangement.spacedBy(8.dp)){OutlinedButton(onClick=resetAll,modifier=Modifier.weight(1f)){Icon(Icons.Default.Refresh,null);Spacer(Modifier.width(6.dp));Text("RESET")};Button(onClick=viewModel::recommend,modifier=Modifier.weight(2f)){Text("FIND BEST MATCHES")}}}
